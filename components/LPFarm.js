...
export default function LPFarm(props){
...
const getFarmerPools = useEffect(() => {
   ...
   const reinvest = () =>{}
    ...
    return(<div className="w-full  lg:w-5/6 xl:w-2/3  card-orangi p-4 mt-10 bg-black bg-opacity-10 ">
        <div className="grid grid-cols-1 md:grid-cols-4">
            ...
            <h2 className='text-2xl font-medium '>Stake FANG</h2>
        ...
        <div className='section w-full py-4'>
            <h2 className='text-xl font-medium'>My staked FANG:</h2>
            <h3>900</h3>
        </div>
        <div className='section w-full py-4'>
